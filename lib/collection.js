...
class CollectionFactory {
  ...
  extend (options = {}) {
    ...
    const collectionClass = class Collection {
      ...
      clone () {
        const attributesList = this.map(record => record.attributes)
        return new this.constructor(attributesList)
      }
    ...
    // 布置迭代器
    collectionClass.prototype[Symbol.iterator] = Array.prototype[Symbol.iterator]
