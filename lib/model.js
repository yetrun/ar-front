const { zipObject, merge, isNil, isFunction } = require('lodash')
...
function defineMethods (Model, { actions, methods, staticMethods }) {
  // 定义 actions
...
class ModelFactory {
  ...
  extend (options = {}) {
    ...
    defineMethods(modelClass, { actions, methods, staticMethods })
